...
return {
	...
	DESCRIBE =
	{
		...
		MANRABBIT_TAIL="Soft and fluffy.",
		MUSHTREE_TALL = {
		...
		RABBITHOUSE=
		{
			GENERIC = "I wanna take a bite of that house.",
			BURNT = "Ah... the smell of fake roasted carrots.",
		},
		SLURTLE="Ew. Just ew.",
		...
		CARROT = "Oh my sweet carrot... ",
		CARROT_COOKED = "Now THIS is something special.",
		CARROT_PLANTED = "Earth's finest gems.",
		CARROT_SEEDS = "The essence of my dreams.",
		...
		RABBIT =
		{
			GENERIC = "He's looking for carrots, just like me.",
			HELD = "I hope we're not related.",
		},
		RABBITHOLE = 
		{
			GENERIC = "I bet they have lots of carrots in there.",
			SPRING = "The carrot store is closed, for now.",
		},
		RAINOMETER = 
		{	
